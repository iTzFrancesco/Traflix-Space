...
export function Sidebar() {
  ...
  return (
    ...
    >
      <div className="p-4">
        <button className="flex items-center gap-2 w-full px-3 py-2 text-sm font-medium text-neutral-text bg-primary/10 border border-primary/20 rounded-lg hover:bg-primary/20 transition-colors">
